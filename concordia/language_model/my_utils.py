...
from concordia.language_model import deepseek_model
from concordia.language_model import qwen_model


# from .together_ai import Llama3
...
def language_model_setup(
  ...
  if api_type == 'amazon_bedrock':
    ...
    if "gemma" in model_name.lower():
      ...
      cls = deepseek_model.DeepSeekLanguageModel
  elif api_type == 'qwen':
    cls = qwen_model.QwenLanguageModel
  else:
