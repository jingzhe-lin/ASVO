...
class MCTSActComponent(entity_component.ActingComponent):
    ...
    def get_action_attempt(
        ...
        tree_thinking_prompt = (f"Now there is a human-like agent named {agent_name}. "
                        f"{agent_name} is a agent with the above value system. "
                        f"All the following answers must be in accordance with this value system."
