...
def build_BabyAGI_agent(*,
    ...
    all_desire_components = init_value_info_social.get_all_desire_components_without_PreAct(model, general_pre_act_label, observation, clock, measurements, detailed_values_dict, expected_values,wanted_desires = selected_desire, social_personality=social_personality)
