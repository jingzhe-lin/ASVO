...
#     f'{IMPORT_AGENT_BASE_DIR}.init_svo_info')
...
from examples.ASVO.ASVO_agent.Value_ActComp import MCTSActComponent
...
def build_D2A_origin_agent(
    *,
    ...
    #print(selected_desire)
    # same as the original
    agent_name = config.name
    raw_memory = legacy_associative_memory.AssociativeMemoryBank(memory)
    measurements = measurements_lib.Measurements()

    #storage_folder = r'D:\gitpro\ASVO\examples\ASVO\result_folder'
    ...
    # svo_pre_act_key = "svo"
    # svo_component =init_svo_info.get_svo_component(
    #     model,
    #     svo_pre_act_key,
    #     observation_summary,
    #     target_tracking_desire_component,
    #     expected_values,
    #     agent_name,
    #     clock,
    #     measurements,
    ...
    # #SVO追踪组件
    # svo_tracker = svo_comp.SVO_Value_Tracker(
    #     pre_act_key="SVO_Tracker",
    #     svo_component=svo_component,
    #     clock_now=clock.now,
    #     logging_channel=measurements.get_channel('SVOTracker').on_next,
    # )
